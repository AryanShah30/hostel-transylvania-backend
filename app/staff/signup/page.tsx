...
const Signup = () => {
  ...
  const [staffID, setRegNo] = useState("");
  ...
  const handleSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post("/api/staff/signup", { name, staffID, email, password });
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-md mb-20" style={{ transform: 'translateY(-20px)' }}>
